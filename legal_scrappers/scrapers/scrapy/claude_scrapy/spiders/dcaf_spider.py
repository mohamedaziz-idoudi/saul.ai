...
class DcafSpiderSpider(scrapy.Spider):
    name = "dcaf_spider"
    allowed_domains = ["legislation-securite.tn"]
    start_urls = [
        "https://legislation-securite.tn/latest-laws/decret-presidentiel-n-2022-691-du-17-aout-2022-portant-promulgation-de-la-constitution-de-la-republique-tunisienne/"
    ]

    def parse(self, response):
        # Define the container with your CSS selector
        container_selector = (
            "body > div.elementor.elementor-74353.elementor-712.elementor-location-single.post-29683.latest-laws.type-latest-laws.status-publish.hentry.status-categories-en-vigueur.text-type-categories-constitution.institution-categories-presidence-de-la-republique > section > div > div.elementor-column.elementor-col-50.elementor-top-column.elementor-element.elementor-element-b973b8c > div > section > div > div.elementor-column.elementor-col-50.elementor-inner-column.elementor-element.elementor-element-fbd68d1 > div > div.elementor-element.elementor-element-a9246bd.elementor-widget.elementor-widget-jet-listing-dynamic-field > div > div > div > div"
        )
